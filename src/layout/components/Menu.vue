...
<script setup lang="ts">
  import { defineComponent, ref, onMounted, reactive, computed, watch, toRefs, unref, defineProps, defineEmits } from 'vue';
  ...
  emit('update:collapsed'); // 绑定并触发父组件的事件：update:collapsed，父组件绑定该属性，执行对应的回调
